        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24">
          <StaggerContainer className="space-y-12">
            <StaggerItem>
               ...
               <p className="text-2xl md:text-3xl font-black uppercase"><span className="text-white">5</span> Documentaries</p>
            ...
            <StaggerItem>
               ...
               <p className="text-2xl md:text-3xl font-black uppercase"><span className="text-white">3</span> City Videos</p>
            ...
            <StaggerItem>
               ...
               <p className="text-2xl md:text-3xl font-black uppercase"><span className="text-white">3</span> Vox Pops</p>
      ...
      <Section id="palladium" className="border-t border-white/10 bg-[#050505]">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-4 divide-y md:divide-y-0 md:divide-x divide-white/10 mb-16">
          <StaggerItem className="pb-8 md:pb-0 md:pr-8">
            <span className="text-7xl font-black text-nike-orange leading-none tracking-tighter block mb-2">3</span>
          ...
          <StaggerItem className="py-8 md:py-0 md:px-8">
            <span className="text-7xl font-black text-white leading-none tracking-tighter block mb-2">4</span>
          ...
          <StaggerItem className="pt-8 md:pt-0 md:pl-8">
            <span className="text-7xl font-black text-nike-orange leading-none tracking-tighter block mb-2">1</span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <FadeIn delay={0.2}>
             <div className="bg-nike-orange text-black p-8 md:p-12 border-l-4 border-black">
               <h3 className="text-2xl md:text-3xl font-black uppercase mb-4">Edit Sequence Delivered<br/>Overnight</h3>
